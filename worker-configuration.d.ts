/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 051a1b3d694d480b87923a3486e2e6d0)
// Runtime types generated with workerd@1.20260801.1 2026-07-18
interface __BaseEnv_Env {
	ATLAS_BUCKET: R2Bucket;
	maps_romanticatlas_assets: R2Bucket;
	ASSETS: Fetcher;
	OPENROUTER_MODEL: "openai/gpt-5.4-image-2";
	ATLAS_ALLOWED_ORIGIN: string;
	ATLAS_ADMIN_TOKEN: string;
	ATLAS_SHARE_ASSET_ORIGIN: string;
	OPENROUTER_API_KEY: string;
	VITE_DIAGNOSTIC_CACHED_TILES: string;
	ATLAS_ADMIN_MODE: string;
	ATLAS_LOCAL_DEV: string;
	ATLAS_MANIFEST_TOKEN: string;
	ATLAS_MANIFEST: DurableObjectNamespace<import("./src/worker").AtlasManifest>;
	FOG_ELIGIBILITY_INDEX_CACHE: DurableObjectNamespace<import("./src/worker").FogEligibilityIndexCache>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AtlasManifest" | "FogEligibilityIndexCache";
	}
